...
summary(model.coint)
```
As a result we can see that intercept is significant because the p-value is less than the significant level. And the variables x1 and x9 are cointegrated because the p-value of x2 in our model is less than the critical value.
